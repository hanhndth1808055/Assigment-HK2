            ...
            @foreach ($seminars as $serminar)
                <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                    <div  class="w-100 d-flex flex-column justify-content-end">
                        <img style="height:250px;object-fit:cover" src={{asset('images').'/'.$serminar->seminar_picture}} alt="">
                    </div>
                    ...
                    <div class="row d-flex flex-row align-items-end">
                        ...
                        <div class="col-lg-2 order-lg-1 order-2">
                            <div class="event_date d-flex flex-column align-items-center justify-content-center">
                                ...
                                //chi hanh fix
                                {{-- <div class="event_day">{{$campaign->created_at->format('d')}}</div>
                                <div class="event_month">{{$campaign->created_at->format('M')}}</div> --}}
                        ...
                        <div class="col-lg-6 order-lg-2 order-3">
                            <div class="event_content">
                                <div class="event_name"><a class="trans_200" href="{{url('campaigns/'.$campaign->id)}}">
                                    {{ $campaign->name }}</a></div>
                        ...
                        <div class="col-lg-4 order-lg-3 order-1">
                            <div class="event_image">
                                <img width="100%" style="height:200px;object-fit:cover"
                                 src="{{$campaign->full_size_thumbnail }}" alt="https://unsplash.com/@theunsteady5">
                            </div>
                        </div>

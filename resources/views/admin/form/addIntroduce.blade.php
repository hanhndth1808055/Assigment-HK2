...
@section('main-content')
    <div class="container mt-5">
            ...
            @endif
        <form action="admin/addIntroduce" method="POST"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
              ...
              <input type="text" name="address" id="" class="form-control" placeholder="" value="{{old('address')}}" aria-describedby="helpId">
                ...
                if (fileInput.files && fileInput.files[0]) {
                    ...
                    reader.onload = function (e) {
                        document.getElementById('viewImg').innerHTML =
                            '<img style="width:320px; height: 200px;" src="' + e.target.result + '"/>';
                    };
